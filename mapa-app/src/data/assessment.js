      ...
      defineQuestion({
        ...
        options: [
          ...
          },
          {
            value: 'b',
            label:
              'Falei na hora o que pensava, sem rodeio — se ninguém aponta, passa errado; prefiro falar com franqueza, mesmo que soe duro.',
            zone: 'Z2',
          },
          {
            value: 'c',
      ...
      defineQuestion({
        ...
        options: [
          ...
          },
          {
            value: 'b',
            label:
              'Travei — fiquei no nervoso, sem saber por onde começar, e demorei um tempão pra conseguir reagir.',
            zone: 'Z1',
          },
          {
            value: 'c',
        ...
        options: [
          {
            value: 'a',
            label:
              'Acabei adiando ou deixando passar — senti que ainda não estava no ponto, que faltava alguma coisa.',
            zone: 'Z1',
          },
          {
            value: 'b',
  ...
  },
  {
    ...
    questions: [
      ...
      defineQuestion({
        ...
        type: 'situation',
        competencyKey: 'protagonismo_profissional',
        text: 'Lembre da última vez que você sentiu que tinha estagnado, sem se desenvolver no trabalho. O que você fez?',
        options: [
          {
            value: 'a',
            label:
